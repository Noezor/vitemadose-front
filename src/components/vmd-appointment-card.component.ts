                ...
                <div class="card-body">
                    <div class="row align-items-center ">
                        <div class="col">
                            ...
                            <div class="row">
                              <vmd-appointment-metadata widthType="full-width" icon="vmdicon-location">
                                <div slot="content">
                              ...
                              <vmd-appointment-metadata widthType="fit-to-content" icon="vmdicon-phone" .displayed="${!!this.lieu.metadata.phone_number}">
